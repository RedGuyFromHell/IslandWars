...
Shader "Casual Hit/Cartoon Transparent"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		_ReflectionCubemapSmoothness ("Cubemap Smoothness", Range(0,1)) = 0.5
		[TCP2Separator]
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _ReflectionCubemapSmoothness;
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float __reflectionCubemapSmoothness = ( _ReflectionCubemapSmoothness );
				...
				fixed4 reflColor = texCUBElod(_Cube, half4(reflectVector.xyz, __reflectionCubemapSmoothness));
				reflColor.rgb *= __reflectionCubemapColor;
